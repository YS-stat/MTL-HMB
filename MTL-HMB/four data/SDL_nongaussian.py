...
for seed in range(num_seeds): 
    set_seed(seed)
    p1, p2, p3, p4, p5 = 100, 25, 25, 25, 25
    p = p1 + p2 + p3 +p4 + p5
    n_t = 300
    n_s = 300
    n_r = 300
    ...
    X_u_hat=torch.cat([X_u_1, X_u_4],dim=1)
    average_test_loss_u = grid_search_integmodel(X_u_hat, y_u, p1+p5, seed=seed)
...
filename = f"SDL_four_data_nongaussian_seeds={num_seeds}.csv"
